          ...
          {activeTab === 'console' && (
            <div className="space-y-1">
              ...
              {logs.length === 0 ? (
                ...
                logs.map((log) => (
                  <div key={log.id} className="flex items-start gap-2 hover:bg-[#161718] px-1 py-0.5 rounded-[4px]">
            ...
            <div className="space-y-1">
              {logs.filter(l => l.type === 'stderr').length === 0 ? (
                ...
                logs.filter(l => l.type === 'stderr').map((log) => (
                  <div key={log.id} className="p-2 bg-[#eb5757]/10 border border-[#eb5757]/30 rounded-[6px] text-[#eb5757] font-mono text-xs">
