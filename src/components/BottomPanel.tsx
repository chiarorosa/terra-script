        ...
        <div className="flex items-center gap-2">
          {(activeTab === 'console' || activeTab === 'problems') && (
            <button
              ...
              className="flex items-center gap-1.5 px-2 py-0.5 text-xs text-[#8b949e] hover:text-[#f85149] bg-[#161b22] hover:bg-[#21262d] border border-[#30363d] rounded transition-colors"
              title="Limpar Saída do Console"
            >
              <Trash2 className="w-3.5 h-3.5 text-[#8b949e] group-hover:text-[#f85149]" />
