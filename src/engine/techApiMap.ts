...
export const API_CATALOG: ApiItem[] = [
  ...
  },
  {
    ...
    usabilityNotes: [
      ...
      '2. Tabela Base: Fibra=1, Madeira=5, Raízes=25, Frutas=80, Energia=200, Biomassa=350 XP.',
